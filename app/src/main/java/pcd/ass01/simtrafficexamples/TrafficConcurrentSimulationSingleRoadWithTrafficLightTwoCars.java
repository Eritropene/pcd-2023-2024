...
public class TrafficConcurrentSimulationSingleRoadWithTrafficLightTwoCars extends AbstractConcurrentSimulation {

    public TrafficConcurrentSimulationSingleRoadWithTrafficLightTwoCars() {
        super();
    }
