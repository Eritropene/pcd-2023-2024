...
public class TrafficConcurrentSimulationSingleRoadMassiveNumberOfCars extends AbstractConcurrentSimulation {

    private int numCars;

    public TrafficConcurrentSimulationSingleRoadMassiveNumberOfCars(int numCars) {
        super();
